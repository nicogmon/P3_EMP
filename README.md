...
Por ultimo para la escirtura de los simbolos % y € en el lcd he definido yo dichos caracteres con la funcion lcd_1.createChar(); y su mapa de bytes correspondiente como bytes iluminados.  
